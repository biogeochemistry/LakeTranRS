...
f = fopen('../inputdata/vansjø_para.txt');
...
initfile='../inputdata/store_init.txt';


if use_INCA == 0
    inputfile='../inputdata/store_INCAP_input_baseline.txt';
...
if isnumeric(use_INCA)
    ...
    if use_INCA == 0
        land_to_vanem = '../inputdata/vanem_INCAP_input_baseline.txt';
    else
    ...
    parafile = lake_par_file;
    initfile='../inputdata/vanem_init.txt';
