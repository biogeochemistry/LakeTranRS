...
def plotsim(simids, fname, stitle):
    ...
    o23 = o23.drop('doy', 1)
    a5.axhline(16, color='pink', legend=False)
    a5.axhline(3000, color='pink', legend=False)
    ...
    a5s.plot([1e-1, 1e4], [3000, 3000], color='pink', linewidth=lw, legend=False)
    a5s.plot([3000, 3000], [1e-1, 1e4], color='pink', linewidth=lw, legend=False)
    a5s.plot([1e-1, 1e4], [16, 16], color='pink', linewidth=lw, legend=False)
    a5s.plot([16, 16], [1e-1, 1e4], color='pink', linewidth=lw, legend=False)
    ...
    a6s.plot([1e-1, 1e4], [3000, 3000], color='pink', linewidth=lw, legend=False)
    a6s.plot([3000, 3000], [1e-1, 1e4], color='pink', linewidth=lw, legend=False)
    a6s.plot([1e-1, 1e4], [16, 16], color='pink', linewidth=lw, legend=False)
    a6s.plot([16, 16], [1e-1, 1e4], color='pink', linewidth=lw, legend=False)
