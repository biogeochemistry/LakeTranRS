...
def plotsim(simids, fname, stitle, writedata=False, marchversion=False):
    ...
    print('creating plots for {:d} variables'.format(5 if marchversion else 11))
    ...
    if marchversion:
        ...
        fig.set_figwidth(9)
        a9 = plt.subplot2grid((nvmarch, 4), (0, 0), colspan = 3)
        a9s = plt.subplot2grid((nvmarch, 4), (0, 3)) 
        a1 = plt.subplot2grid((nvmarch, 4), (1, 0), colspan = 3)
        a1s = plt.subplot2grid((nvmarch, 4), (1, 3))
        a4 = plt.subplot2grid((nvmarch, 4), (2, 0), colspan = 3)
        a4s = plt.subplot2grid((nvmarch, 4), (2, 3)) 
        a6 = plt.subplot2grid((nvmarch, 4), (3, 0), colspan = 3)
