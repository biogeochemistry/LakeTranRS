...
def plotsim(simids, fname, stitle):
    ...
    a6s.axhline(3000, color='pink', legend=False)
    a6s.axhline(16, color='pink', legend=False)
    a6s.axvline(3000, color='pink', legend=False)
    a6s.axvline(16, color='pink', legend=False)
