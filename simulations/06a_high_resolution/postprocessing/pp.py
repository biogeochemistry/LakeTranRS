...
# a5.text(2.0, -0.9, 'T', ha='center', va='center') ; a5.text(-0.6, 2.0, 'FE', va='center', ha='right', rotation='vertical')
# a6.text(2.0, -0.9, 'T', ha='center', va='center') ; a6.text(-0.6, 2.0, 'FE', va='center', ha='right', rotation='vertical')
...
# a9.text(2.0, -0.9, 'TP', ha='center', va='center') ; a9.text(-0.6, 2.0, 'FE', va='center', ha='right', rotation='vertical')
# a10.text(2.0, -0.9, 'TP', ha='center', va='center') ; a10.text(-0.6, 2.0, 'FE', va='center', ha='right', rotation='vertical')
# a11.text(2.0, -0.9, 'FE', ha='center', va='center') ; a11.text(-0.6, 2.0, 'DOC', va='center', ha='right', rotation='vertical')
# a12.text(2.0, -0.9, 'FE', ha='center', va='center') ; a12.text(-0.6, 2.0, 'DOC', va='center', ha='right', rotation='vertical')
