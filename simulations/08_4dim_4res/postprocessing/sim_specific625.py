...
basedir = '../simulations/id/00625/'
inbasedir = '../intermediate/id/00625a/'
...
def plotsim(simids, fname, stitle):
    ...
    qst = [pd.read_csv(os.path.join(dir, 'Qst.csv'), header=None)
           for dir in dirs] # ('sw', 'lw', 'sl')
    sw = pd.concat([d.iloc[:, 0] for d in qst], axis=1)
    sw.columns = colnames
    sw.index = ser
    lam = [pd.read_csv(os.path.join(dir, 'lambda.csv'), header=None)
           for dir in dirs]
    ...
    ## water temperature
    t = [pd.read_csv(os.path.join(dir, 't.csv'), header=None)
         for dir in dirs]
    ...
    ## ice
    his = [pd.read_csv(os.path.join(dir, 'His.csv'), header=None)
           for dir in dirs]
    ...
    ## oxygen
    o2 = [pd.read_csv(os.path.join(dir, 'O2abs.csv'), header=None)
          for dir in dirs]
    ...
    chl = [pd.read_csv(os.path.join(dir, 'chl.csv'), header=None)
          for dir in dirs]
    ...
    tp = [pd.read_csv(os.path.join(dir, 'totp.csv'), header=None)
          for dir in dirs]
